  ...
  },
  {
    ...
    image: "ricesteak.jpg"//https://www.google.com/search?q=rice+and+steak&sca_esv=67b46ba106913391&rlz=1C5CHFA_enUS963US963&udm=2&biw=1760&bih=887&sxsrf=AE3TifMMtkGwBcR3IqQY0B2sWnOzMXIrQw%3A1762015859573&ei=czoGaZi_Irrf5NoPuarpyAg&ved=0ahUKEwjYxJfLtNGQAxW6L1kFHTlVGokQ4dUDCBQ&uact=5&oq=rice+and+steak&gs_lp=&sclient=gws-wiz-img#vhid=gL7H3eV01Dt3LM&vssid=mosaic
  },
  {
    recipeId: 5,
    time: 60,
...
// It Displays all the recipes when you search
function displayRecipes() {
  const container = document.getElementById('list');
  const searchText = document.getElementById('q').value.toLowerCase();
  ...
  for (let i = 0; i < recipes.length; i++) {
    ...
    if (showRecipe) {
      ...
      //creates recipes with the element card
  ...
  for (let i = 0; i < daySelects.length; i++) {
    daySelects[i].onchange = function() {
      const recipeId = parseInt(this.getAttribute('data-recipe-id'));
...
document.getElementById('q').oninput = displayRecipes;
